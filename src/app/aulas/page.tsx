...
export default async function Page() {
  ...
  return (
    <div className="rounded-2xl p-6" style={{ background: "rgba(15,26,43,0.72)", border: "1px solid rgba(246,247,248,0.12)" }}>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-2xl font-semibold">Aulas grátis - Youtube</h2>
          <p className="mt-2 text-sm" style={{ color: "rgba(246,247,248,0.72)" }}>
        ...
        <a
          ...
          style={{ background: "#fff", color: "#0b1422" }}
        >
      ...
      {error === "missing-env" ? (
        <div className="mt-6 rounded-xl px-4 py-3 text-sm" style={{ border: "1px solid rgba(255,255,255,0.18)", color: "rgba(246,247,248,0.85)" }}>
